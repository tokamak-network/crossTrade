...
describe("USDC CrossTrade Test", function () {
  ...
  describe("FW USDC Test", () => {
    it("requestFW (USDC) in L2", async () => {
      ...
      // console.log('before L2 USDC (L2CrossTradeBalance): ', beforeContractBalance.toString())
      ...
      // console.log('after L2 USDC (L2CrossTradeBalance): ', afterContractBalance.toString())
