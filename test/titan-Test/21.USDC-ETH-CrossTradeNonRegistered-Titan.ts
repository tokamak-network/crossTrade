...
describe("Provide(USDC)-Request(ETH)-Titan", function () {
    ...
    describe("CrossTrade Test", () => {
      describe("requestNonRegisteredToken Test", () => {
        it("requestNonRegisteredToken(USDC,ETH) in L2", async () => {
        ...
        // it("faucet USDC to user1 in L1", async () => {
        ...
        it("providerCT(USDC,ETH) in L1", async () => {
          let beforel2Balance = await l2Wallet.getBalance()
