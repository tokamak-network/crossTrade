    ...
    describe("CrossTrade Test", () => {
      describe("requestNonRegisteredToken & cancel", () => {
        ...
        it("Cancel(ERC20) in L1", async () => {
          let beforel2NativeTokenBalance = await l2erc20Token.balanceOf(
            l2user1.address
          )
          // console.log("beforel2NativeTokenBalance(Provider) : ", beforel2NativeTokenBalance.toString())
          let beforel2NativeTokenBalanceWallet = await l2erc20Token.balanceOf(
            l2Wallet.address
          )
          // console.log("beforel2NativeTokenBalanceWallet(Requester) : ", beforel2NativeTokenBalanceWallet.toString())

          let beforeL2CrossTradeBalance = await l2erc20Token.balanceOf(
            L2CrossTradeContract.address
          )
          ...
          let afterl2NativeTokenBalance = await l2erc20Token.balanceOf(
            l2user1.address
          )
          // console.log("afterl2NativeTokenBalance(Provider) : ", afterl2NativeTokenBalance.toString())
    
          let afterl2NativeTokenBalanceWallet = await l2erc20Token.balanceOf(
            l2Wallet.address
          )
          // console.log("afterl2NativeTokenBalanceWallet(Requester) : ", afterl2NativeTokenBalanceWallet.toString())

          let afterL2CrossTradeBalance = await l2erc20Token.balanceOf(
            L2CrossTradeContract.address
          )
