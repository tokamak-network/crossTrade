...
describe("4.FWERC20EditCancel", function () {
  ...
  describe("FW ERC20 edit, cancel Test", () => {
    ...
    it("before fail CancelFW", async () => {
      ...
      beforeL2Contract = await l2MockERC20.balanceOf(L2CrossTradeContract.address)
      // console.log('before  L2 ERC20 (L2CrossTradeBalance): ', L2CrossTradeBalance.toString())
    })
    ...
    it("after fail CancelFw", async () => {
      ...
      afterL2Contract = await l2MockERC20.balanceOf(L2CrossTradeContract.address)
      // console.log('after  L2 ERC20 (L2CrossTradeBalance): ', afterL2Contract.toString())
