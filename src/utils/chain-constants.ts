...
import predeploys from '../../test/data/predeployed.devnetL1.json';
import { ethers } from 'ethers'
import portalArtifactsMainnet from '../../contracts-bedrock/deployments/mainnet/OptimismPortalProxy.json'
import portalArtifactsGoerli from '../../contracts-bedrock/deployments/goerli/OptimismPortalProxy.json'
import portalArtifactsSepolia from '../../contracts-bedrock/deployments/sepolia/OptimismPortalProxy.json'
import portalArtifactsTitanSepoliaTest from '../../contracts-bedrock/deployments/thanos-sepolia-test/OptimismPortalProxy.json'
import l2OutputOracleArtifactsMainnet from '../../contracts-bedrock/deployments/mainnet/L2OutputOracleProxy.json'
import l2OutputOracleArtifactsGoerli from '../../contracts-bedrock/deployments/goerli/L2OutputOracleProxy.json'
import l2OutputOracleArtifactsSepolia from '../../contracts-bedrock/deployments/sepolia/L2OutputOracleProxy.json'
import l2OutputOracleArtifactsTitanSepoliaTest from '../../contracts-bedrock/deployments/thanos-sepolia-test/L2OutputOracleProxy.json'
import addressManagerArtifactMainnet from '../../contracts-bedrock/deployments/mainnet/AddressManager.json'
import addressManagerArtifactGoerli from '../../contracts-bedrock/deployments/goerli/AddressManager.json'
import addressManagerArtifactSepolia from '../../contracts-bedrock/deployments/sepolia/AddressManager.json'
import addressManagerArtifactTitanSepoliaTest from '../../contracts-bedrock/deployments/thanos-sepolia-test/AddressManager.json'
import l1StandardBridgeArtifactMainnet from '../../contracts-bedrock/deployments/mainnet/L1StandardBridgeProxy.json'
import l1StandardBridgeArtifactGoerli from '../../contracts-bedrock/deployments/goerli/L1StandardBridgeProxy.json'
import l1StandardBridgeArtifactSepolia from '../../contracts-bedrock/deployments/sepolia/L1StandardBridgeProxy.json'
import l1StandardBridgeArtifactTitanSepoliaTest from '../../contracts-bedrock/deployments/thanos-sepolia-test/L1StandardBridgeProxy.json'
import l1CrossDomainMessengerArtifactMainnet from '../../contracts-bedrock/deployments/mainnet/L1CrossDomainMessengerProxy.json'
import l1CrossDomainMessengerArtifactGoerli from '../../contracts-bedrock/deployments/goerli/L1CrossDomainMessengerProxy.json'
import l1CrossDomainMessengerArtifactSepolia from '../../contracts-bedrock/deployments/sepolia/L1CrossDomainMessengerProxy.json'
import l1CrossDomainMessengerArtifactTitanSepoliaTest from '../../contracts-bedrock/deployments/thanos-sepolia-test/L1CrossDomainMessengerProxy.json'
