...
async function main() {
  ...
  // let L2CrossTradeProxy = await ethers.getContractAt("L2CrossTradeProxy","0x99444908E6FD4472f6a0dEf076Ee157966Ec989C");

  // console.log("upgrade proxy to logic...")
  // await L2CrossTradeProxy.upgradeTo("0xB35C07b9533CA96a9436e3e452f25302b8ea9Afb");
