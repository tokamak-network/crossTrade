...
// import { L1CrossTradeStorageNew } from "./L1CrossTradeStorageNew.sol";

// contract L1CrossTrade is  L1CrossTradeStorageNew {
...
//         setChainInfo(_crossDomainMessenger,_l2CrossTrade,_l2chainId);    
//         isInitialized = true;
//     }
...
//     // params[0] = abi.encode(msg.sender); // param1
//     // params[2] = abi.encode(uint256(42)); // param3

//     // callDynamicFunctionWithDynamicParams(
//     //     targetAddress,
//     //     functionSignature,
//     //     params,
//     //     1, // `message` is at index 1
//     //     100000 // _minGasLimit
//     // );
...
//         bool isNativeToken,  // should we keep it this way ? We only care if the L1Token is Native token or if is erc20Token.
//         uint256 _totalAmount,
...
//         // work on this. how many params.
//         (bool success, bytes memory returnData) = _messengerAddress.call{gas: _minGasLimit}(
//             abi.encodeWithSignature(_functionSignature, message)
//         );

//         require(success, "Call to the messenger failed");
...
//         if (isNativeToken && l1token == address(0)) {
//             require(msg.value == ctAmount, "CT: ETH need same amount");
//             (bool sent, ) = payable(_requestor).call{value: msg.value}("");
//             require(sent, "claim fail");
//         } else {
