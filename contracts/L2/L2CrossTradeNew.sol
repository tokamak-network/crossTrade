...
// import { L2CrossTradeStorageNew } from "./L2CrossTradeStorageNew.sol";
// import { IL2CrossDomainMessenger } from "../interfaces/IL2CrossDomainMessenger.sol";

// // import "hardhat/console.sol";

// contract L2CrossTradeNew is  L2CrossTradeStorage {
...
//         setChainInfo(_l1CrossTrade,_l1legacyERC20,_chainId);
//         isInitialized = true;
//     }
...
//         require(registerCheck[msg.sender][id] == false, "already registerToken");
//         registerCheck[msg.sender][id] = true;
//     }
...
//         require(registerCheck[msg.sender][id] != false, "already deleteToken");
//         registerCheck[msg.sender][id] = false;
//     }
...
//         require(registerCheck[_registrar][id] == true, "not register token");
...
//     // checkL1(_chainId,registrarAddress) => can claim if the registrar registered the right values. 
